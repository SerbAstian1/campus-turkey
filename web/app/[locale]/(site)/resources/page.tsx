...
import { ResourcesSeo } from "@/components/seo/routes";
...
export async function generateMetadata(
  ...
  return pageMetadata({
  title: t("Guides and resources"),
  description: t("Guides, checklists and explainers on applying to Turkish universities, visas and student life."),
  path: "/resources",
...
export default async function Page({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <Hydrated server={<ResourcesSeo locale={locale as Locale} />}>
      <Resources />
    </Hydrated>
  );
}
