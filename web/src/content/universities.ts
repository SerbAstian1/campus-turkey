...
const FEATURED: Seed[] = [
  ...
  { name: "Bayburt University", city: "Bayburt", type: "Public", tuition: "", languages: ["Turkish"], founded: 2008, about: "A state university in Bayburt, in the north-eastern Black Sea region, founded in 2008.", lat: 40.2552, lng: 40.2249 },
  { name: "Iğdır University", city: "Iğdır", type: "Public", tuition: "", languages: ["Turkish"], founded: 2008, about: "A state university in Iğdır, in the far east of Türkiye near the Armenian and Iranian borders, founded in 2008.", lat: 39.9237, lng: 44.0450 },
  { name: "Bolu Abant İzzet Baysal University", city: "Bolu", type: "Public", tuition: "", languages: ["Turkish"], founded: 1992, about: "A state university in Bolu, midway between Istanbul and Ankara, founded in 1992.", lat: 40.7100, lng: 31.5200 },
  { name: "Adana Alparslan Türkeş Science and Technology University", city: "Adana", type: "Public", tuition: "", languages: ["Turkish"], founded: 2011, about: "A state university in Adana concentrating on engineering and the natural sciences, founded in 2011.", lat: 37.0600, lng: 35.3600 },
];
